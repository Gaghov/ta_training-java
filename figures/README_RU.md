...
### Описание
Нужно сделать так, чтобы классы  [`Triangle`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Triangle.java),
[`Quadrilateral`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Quadrilateral.java),
[`Circle`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Circle.java) расширяли абстрактный класс [`Figure`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Figure.java).
...
3. `public String pointsToString()`\
    ...
    *Примечание:* можно реализовать toString () в классе [`Point`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Point.java).
...
Класс [`Point`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Point.java) уже реализован.
