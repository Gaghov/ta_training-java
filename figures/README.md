...
### Description
Please, make [`Triangle`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Triangle.java),
[`Quadrilateral`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Quadrilateral.java),
[`Circle`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Circle.java) classes
extend [`Figure`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Figure.java) abstract class.
...
1. `public String pointsToString()`\
    ...
    *Note:*: you may benefit from implementing toString() in the [`Point`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Point.java) class
...
[`Point`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/figures/Point.java) class is already there.
