...
Перейдите в класс [HelloStrangers](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/meetstrangers/HelloStrangers.java) и напишите простую программу, которая:
