...
Please, implement methods of class [`Triangle`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/triangle/Triangle.java):
...
Class [`Point`](src/main/java/com/epam/training/student_Gagik_Hovhannisyan/triangle/Point.java) is already there.
